...
const translations = {
  ko: {
    ...
    "auth.switchToSignup": "아직 계정이 없으신가요?",
    "auth.switchToLogin": "이미 계정이 있으신가요?",
    "auth.signupLink": "회원가입",
    "auth.loginLink": "로그인",
    "auth.benefits.title": "가입하면 이런 혜택이!",
    ...
    "auth.agreeRequiredBoth": "회원가입하려면 이용약관과 개인정보처리방침에 모두 동의해주세요",
    ...
    // Purchase Flow
    "purchase.confirmTitle": "주문 확인",
    "purchase.promoStep": "프로모션 선택",
    "purchase.packageStep": "크레딧 선택",
    "purchase.paymentStep": "결제",
    "purchase.promoInCheckout": "프로모션 코드가 있으시면 결제창에서 입력해 주세요.",
    "purchase.skip": "다음",
    "purchase.next": "다음",
    "purchase.back": "이전",
    ...
    // Landing
    "hero.badge": "온라인 쇼핑 실패, 이제 끝",
    "hero.title1": "또 안 맞는 옷,",
    "hero.title2": "사실 건가요?",
    "hero.subtitle": "옷은 물론, 모자·신발·가방·쥬얼리까지 — 사기 전에 입어보세요.",
    "hero.cta": "무료로 체험하기",
    "hero.painPoint": "온라인 의류 반품률 평균 30% — 안 맞는 옷에 돈 낭비하고 계신가요?",
    "feature.speed": "30초 만에 완성",
    "feature.face": "내 얼굴 그대로",
    "feature.report": "AI 스타일 분석까지",
    "beforeAfter.title": "이게 진짜 나야?",
    "beforeAfter.subtitle": "내 사진 + 원하는 옷 = 실제 착용 모습",
    ...
    "benefits.4": "\"브랜드 추천 좀\" → 체형 맞춤 브랜드 제안",
    "howto.title": "어떻게 사용하나요?",
    "howto.subtitle": "4단계로 가상 피팅 + 스타일 분석 완성",
    "howto.step1.title": "사진 업로드",
    "howto.step1.desc": "내 사진을 올려주세요",
    "howto.step2.title": "아이템 선택",
    "howto.step2.desc": "입어보고 싶은 옷, 모자, 신발, 가방, 쥬얼리를 추가하세요",
    ...
    "cta.title": "실패 없는 쇼핑, 지금 시작하세요",
    "cta.subtitle": "회원가입 시 무료 크레딧 제공",
    "cta.button": "무료로 체험하기",
    ...
    "testimonial.1.text": "입어보고 사서 반품 없이 쇼핑했어요. 진짜 게임체인저!",
    "testimonial.1.author": "Sarah M.",
    "testimonial.1.role": "패션 매니아",
    "testimonial.2.text": "드디어 반품 걱정 없이 온라인 쇼핑할 수 있어요.",
    "testimonial.2.author": "Jessica L.",
    "testimonial.2.role": "온라인 쇼퍼",
    "testimonial.3.text": "AI 스타일 리포트만으로도 가치가 있어요. 개인 스타일리스트 같아요.",
    "testimonial.3.author": "Mike R.",
    "testimonial.3.role": "스타일 전문가",
    "testimonials.title": "사용자 후기",
    "testimonials.subtitle": "사용자들의 리얼 후기를 확인하세요",
    "trust.noCard": "카드 등록 불필요",
    "trust.freeCredits": "가입 시 무료 크레딧",
    "trust.instant": "즉시 결과 확인",
    "hero.socialProof": "수천 명이 선택한 스마트 쇼핑",
    ...
    // Accessory Style Profile
    "accessoryProfile.title": "악세서리 스타일 프로필",
    "accessoryProfile.subtitle": "더 정확한 악세서리 스타일링 분석을 위해 정보를 입력해주세요",
    "accessoryProfile.faceShape.label": "얼굴형",
    "accessoryProfile.faceShape.round": "둥근형",
    "accessoryProfile.faceShape.oval": "계란형",
    "accessoryProfile.faceShape.square": "각진형",
    "accessoryProfile.faceShape.heart": "하트형",
    "accessoryProfile.faceShape.long": "긴 얼굴형",
    "accessoryProfile.hatStyle.label": "선호 모자 스타일",
    "accessoryProfile.hatStyle.casual": "캐주얼",
    "accessoryProfile.hatStyle.sporty": "스포티",
    "accessoryProfile.hatStyle.elegant": "우아한",
    "accessoryProfile.hatStyle.street": "스트릿",
    "accessoryProfile.hatStyle.vintage": "빈티지",
    "accessoryProfile.legShape.label": "다리 형태",
    "accessoryProfile.legShape.straight": "일자형",
    "accessoryProfile.legShape.oLeg": "O자형",
    "accessoryProfile.legShape.xLeg": "X자형",
    "accessoryProfile.legShape.long": "긴 다리",
    "accessoryProfile.legShape.short": "짧은 다리",
    "accessoryProfile.shoeStyle.label": "선호 신발 스타일",
    "accessoryProfile.shoeStyle.sneakers": "스니커즈",
    "accessoryProfile.shoeStyle.boots": "부츠",
    "accessoryProfile.shoeStyle.loafers": "로퍼",
    "accessoryProfile.shoeStyle.heels": "힐",
    "accessoryProfile.shoeStyle.sandals": "샌들",
    "accessoryProfile.bagUsage.label": "가방 사용 목적",
    "accessoryProfile.bagUsage.commute": "통근/통학",
    "accessoryProfile.bagUsage.travel": "여행",
    "accessoryProfile.bagUsage.casual": "일상",
    "accessoryProfile.bagUsage.formal": "격식",
    "accessoryProfile.bagStyle.label": "선호 가방 스타일",
    "accessoryProfile.bagStyle.minimal": "미니멀",
    "accessoryProfile.bagStyle.luxury": "럭셔리",
    "accessoryProfile.bagStyle.sporty": "스포티",
    "accessoryProfile.bagStyle.casual": "캐주얼",
    "accessoryProfile.bagStyle.vintage": "빈티지",
    "accessoryProfile.skinTone.label": "피부 톤",
    "accessoryProfile.skinTone.warm": "웜톤",
    "accessoryProfile.skinTone.cool": "쿨톤",
    "accessoryProfile.skinTone.neutral": "뉴트럴",
    "accessoryProfile.skinTone.unknown": "잘 모르겠어요",
    "accessoryProfile.jewelryType.label": "쥬얼리 종류",
    "accessoryProfile.jewelryType.necklace": "목걸이",
    "accessoryProfile.jewelryType.earring": "귀걸이",
    "accessoryProfile.jewelryType.ring": "반지",
    "accessoryProfile.jewelryType.bracelet": "팔찌",
    "accessoryProfile.jewelryStyle.label": "선호 쥬얼리 스타일",
    "accessoryProfile.jewelryStyle.delicate": "섬세한",
    "accessoryProfile.jewelryStyle.bold": "볼드/화려한",
    "accessoryProfile.jewelryStyle.classic": "클래식",
    "accessoryProfile.jewelryStyle.modern": "모던",
    "accessoryProfile.jewelryStyle.bohemian": "보헤미안",
    "accessoryProfile.concerns.hat": "예: 얼굴이 작아 보이면 좋겠어요, 이마가 넓어서 고민이에요...",
    "accessoryProfile.concerns.shoes": "예: 키가 커 보이면 좋겠어요, 발이 편한 게 중요해요...",
    "accessoryProfile.concerns.bag": "예: 체형이 균형 잡혀 보이면 좋겠어요, 수납이 많아야 해요...",
    "accessoryProfile.concerns.jewelry": "예: 목이 길어 보이면 좋겠어요, 피부 톤에 맞는 색상이 궁금해요...",
    ...
    "result.estimatedTime": "예상 소요: 15~30초",
    "result.estimatedTimeFull": "예상 소요: 30~45초",
    "result.stepLabel": "단계",
  ...
  en: {
    ...
    "auth.benefits.title": "Benefits of signing up",
    ...
    "auth.agreeRequiredBoth": "Please agree to both Terms of Service and Privacy Policy to sign up",
    ...
    // Purchase Flow
    "purchase.confirmTitle": "Confirm Order",
    "purchase.promoStep": "Select Promo",
    "purchase.packageStep": "Select Package",
    "purchase.paymentStep": "Payment",
    "purchase.promoInCheckout": "Have a promo code? You can enter it on the checkout page.",
    "purchase.skip": "Skip",
    "purchase.next": "Next",
    "purchase.back": "Back",
    ...
    "purchase.lemonSqueezyNote": "Credits will be added automatically after payment.",
    ...
    // Landing
    "hero.badge": "Trusted by 10,000+ shoppers",
    "hero.title1": "See it on YOU",
    "hero.title2": "before you buy.",
    "hero.subtitle": "AI-powered virtual try-on for clothes, hats, shoes, bags & jewelry. Stop guessing. Start knowing.",
    "hero.cta": "Try It Free →",
    "hero.painPoint": "30% of online clothes get returned. Don't be a statistic.",
    "hero.socialProof": "Join thousands who shop smarter",
    "feature.speed": "Results in 30 sec",
    "feature.face": "Uses your real photo",
    "feature.report": "AI style report included",
    "beforeAfter.title": "See the Difference",
    "beforeAfter.subtitle": "Your photo + any item = instant try-on preview",
    "beforeAfter.label.before": "Before",
    "beforeAfter.label.after": "After",
    "benefits.title": "Why Trupickai?",
    "benefits.subtitle": "The smarter way to shop online",
    "benefits.1": "See exactly how clothes look on YOUR body before buying",
    "benefits.2": "Try on accessories too — hats, shoes, bags & jewelry",
    "benefits.3": "Get AI-powered style recommendations matched to you",
    "benefits.4": "Save money by avoiding returns and bad purchases",
    "howto.title": "How It Works",
    "howto.subtitle": "From upload to outfit in under a minute",
    "howto.step1.title": "Upload Your Photo",
    "howto.step1.desc": "Snap a quick full-body photo or use one you already have",
    "howto.step2.title": "Pick Any Item",
    "howto.step2.desc": "Upload any clothing or accessory image from any store",
    "howto.step3.title": "Get Your Try-On",
    "howto.step3.desc": "AI puts the item on you in seconds — see how it really looks",
    "howto.step4.title": "Style Report",
    "howto.step4.desc": "Get personalized fit analysis and styling recommendations",
    "cta.title": "Shop with confidence. Try before you buy.",
    "cta.subtitle": "Free credits when you sign up — no credit card required",
    "cta.button": "Get Started Free →",
    "testimonial.1.text": "I saved so much money by seeing outfits on me first. Total game changer.",
    "testimonial.1.author": "Sarah M.",
    "testimonial.1.role": "Fashion Enthusiast",
    "testimonial.2.text": "Finally, I can shop online without the anxiety of returns.",
    "testimonial.2.author": "Jessica L.",
    "testimonial.2.role": "Online Shopper",
    "testimonial.3.text": "The AI style report alone is worth it. It's like having a personal stylist.",
    "testimonial.3.author": "Mike R.",
    "testimonial.3.role": "Style-Conscious Professional",
    "testimonials.title": "Loved by Shoppers",
    "testimonials.subtitle": "See what our users are saying",
    "trust.noCard": "No credit card required",
    "trust.freeCredits": "Free credits on signup",
    ...
    "footer.companyInfo": "Trukin | Contact: admin@trukin.app",
    ...
    // Accessory Style Profile
    "accessoryProfile.title": "Accessory Style Profile",
    "accessoryProfile.subtitle": "Enter info for more accurate accessory styling analysis",
    "accessoryProfile.faceShape.label": "Face Shape",
    "accessoryProfile.faceShape.round": "Round",
    "accessoryProfile.faceShape.oval": "Oval",
    "accessoryProfile.faceShape.square": "Square",
    "accessoryProfile.faceShape.heart": "Heart",
    "accessoryProfile.faceShape.long": "Long/Oblong",
    "accessoryProfile.hatStyle.label": "Preferred Hat Style",
    "accessoryProfile.hatStyle.casual": "Casual",
    "accessoryProfile.hatStyle.sporty": "Sporty",
    "accessoryProfile.hatStyle.elegant": "Elegant",
    "accessoryProfile.hatStyle.street": "Street",
    "accessoryProfile.hatStyle.vintage": "Vintage",
    "accessoryProfile.legShape.label": "Leg Shape",
    "accessoryProfile.legShape.straight": "Straight",
    "accessoryProfile.legShape.oLeg": "O-shaped",
    "accessoryProfile.legShape.xLeg": "X-shaped",
    "accessoryProfile.legShape.long": "Long Legs",
    "accessoryProfile.legShape.short": "Short Legs",
    "accessoryProfile.shoeStyle.label": "Preferred Shoe Style",
    "accessoryProfile.shoeStyle.sneakers": "Sneakers",
    "accessoryProfile.shoeStyle.boots": "Boots",
    "accessoryProfile.shoeStyle.loafers": "Loafers",
    "accessoryProfile.shoeStyle.heels": "Heels",
    "accessoryProfile.shoeStyle.sandals": "Sandals",
    "accessoryProfile.bagUsage.label": "Bag Usage",
    "accessoryProfile.bagUsage.commute": "Commute",
    "accessoryProfile.bagUsage.travel": "Travel",
    "accessoryProfile.bagUsage.casual": "Casual",
    "accessoryProfile.bagUsage.formal": "Formal",
    "accessoryProfile.bagStyle.label": "Preferred Bag Style",
    "accessoryProfile.bagStyle.minimal": "Minimal",
    "accessoryProfile.bagStyle.luxury": "Luxury",
    "accessoryProfile.bagStyle.sporty": "Sporty",
    "accessoryProfile.bagStyle.casual": "Casual",
    "accessoryProfile.bagStyle.vintage": "Vintage",
    "accessoryProfile.skinTone.label": "Skin Tone",
    "accessoryProfile.skinTone.warm": "Warm",
    "accessoryProfile.skinTone.cool": "Cool",
    "accessoryProfile.skinTone.neutral": "Neutral",
    "accessoryProfile.skinTone.unknown": "Not Sure",
    "accessoryProfile.jewelryType.label": "Jewelry Type",
    "accessoryProfile.jewelryType.necklace": "Necklace",
    "accessoryProfile.jewelryType.earring": "Earring",
    "accessoryProfile.jewelryType.ring": "Ring",
    "accessoryProfile.jewelryType.bracelet": "Bracelet",
    "accessoryProfile.jewelryStyle.label": "Preferred Jewelry Style",
    "accessoryProfile.jewelryStyle.delicate": "Delicate",
    "accessoryProfile.jewelryStyle.bold": "Bold/Statement",
    "accessoryProfile.jewelryStyle.classic": "Classic",
    "accessoryProfile.jewelryStyle.modern": "Modern",
    "accessoryProfile.jewelryStyle.bohemian": "Bohemian",
    "accessoryProfile.concerns.hat": "e.g., I want my face to look smaller, I have a wide forehead...",
    "accessoryProfile.concerns.shoes": "e.g., I want to look taller, comfort is important...",
    "accessoryProfile.concerns.bag": "e.g., I want balanced body proportions, need lots of storage...",
    "accessoryProfile.concerns.jewelry": "e.g., I want my neck to look longer, looking for colors that match my skin tone...",
    ...
    "result.estimatedTime": "Est. time: 15~30 sec",
    "result.estimatedTimeFull": "Est. time: 30~45 sec",
