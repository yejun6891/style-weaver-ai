...
const translations = {
  ko: {
    ...
    "upload.guide.person.angle": "카메라를 정면으로 응시하고, 수평으로 촬영해주세요",
    "upload.guide.person.background": "복잡한 배경은 피해주세요 (사찰, 벽지 무늬, 사람이 많은 곳보다 단색 벽이나 깨끗한 배경)",
    "upload.guide.person.objects": "몸 주위에 아무것도 없는 사진이 좋아요 (나무, 조각상, 난간 등에 몸이 붙어 있으면 옷을 입히기 어려워요)",
    "upload.guide.person.size": "내 모습이 선명하게 나와야 해요 (너무 멀리서 찍어 내 몸이 작게 나오는 사진은 피해주세요)",
    "upload.guide.person.noGroup": "단체 사진은 사용할 수 없어요",
    "upload.guide.person.noHolding": "물건을 들고 있으면 안돼요",
    ...
    "upload.guide.garment.model": "모델 착용 사진도 가능하지만, 옷 형태가 명확하게 보여야 해요",
    "upload.top.label": "상의",
  ...
  en: {
    ...
    "upload.guide.person.angle": "Face the camera directly and shoot horizontally",
    "upload.guide.person.background": "Avoid busy backgrounds (temples, patterned walls, crowded areas - plain walls or clean backgrounds work best)",
    "upload.guide.person.objects": "Photos with nothing around your body work best (trees, statues, railings touching your body make it hard to fit clothes)",
    ...
    "upload.guide.person.noHolding": "Don't hold any objects",
    ...
    "upload.guide.garment.model": "Model photos are OK, but the garment shape must be clearly visible",
