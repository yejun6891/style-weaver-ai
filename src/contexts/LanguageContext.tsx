...
const translations = {
  ko: {
    ...
    "hero.title2": "사실 건가요?",
    "hero.subtitle": "사이즈 실패, 반품 스트레스. 사기 전에 입어보면 끝나는 문제입니다.",
    "hero.cta": "무료로 입어보기",
    "hero.painPoint": "온라인 쇼핑 실패율 40% — 안 맞는 옷에 돈 낭비하고 계신가요?",
  ...
  en: {
    ...
    "hero.subtitle": "Wrong size, return hassle. Try it on before you buy — problem solved.",
    "hero.cta": "Try it on free",
    "hero.painPoint": "40% of online purchases get returned — stop wasting money on clothes that don't fit.",
