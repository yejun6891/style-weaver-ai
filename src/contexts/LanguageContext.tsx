...
const translations = {
  ko: {
    ...
    "upload.guide.garment.lengthMatch": "⚠️ 내 사진과 옷 사진의 소매/바지 길이가 비슷해야 자연스러워요 (긴팔→긴팔, 반팔→반팔)",
    "upload.top.label": "상의",
  ...
  en: {
    ...
    "upload.guide.garment.lengthMatch": "⚠️ Sleeve/pants length should match your photo (long sleeve→long sleeve, short→short)",
