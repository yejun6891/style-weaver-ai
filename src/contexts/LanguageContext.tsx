...
const translations = {
  ko: {
    ...
    "benefits.1": "\"이 옷 나한테 어울릴까?\" → 사기 전에 확인",
    "benefits.2": "\"내 체형에 맞을까?\" → AI가 피팅해서 보여줌",
    ...
    "cta.subtitle": "회원가입 없이 바로 체험 — 무료 크레딧 제공",
    "cta.button": "무료로 입어보기",
  ...
  en: {
    ...
    "benefits.1": "\"Will this look good on me?\" → See before you buy",
    "benefits.2": "\"Will it fit my body?\" → AI fits it for you",
    ...
    "cta.subtitle": "No sign up required — free credits included",
    "cta.button": "Try it on free",
    "footer.copyright": "© 2025 Trukin. All rights reserved.",
