...
const translations = {
  ko: {
    ...
    "purchase.pay": "결제하기",
    "purchase.lemonSqueezyNote": "할인코드가 있다면 결제창에서 입력해주세요. 결제 완료 후 크레딧이 충전됩니다.",
  ...
  en: {
    ...
    "purchase.lemonSqueezyNote": "Enter discount code in checkout for final discount. Credits will be added after payment.",
