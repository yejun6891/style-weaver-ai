...
• Business partners with your explicit consent`
        },
        {
          ...
          content: `We retain your personal information for as long as your account is active or as needed to provide you services. Uploaded images for virtual try-on are automatically deleted within 1 hour after processing. You may request deletion of your data at any time by contacting us.`
        },
        {
...
• 귀하의 명시적 동의가 있는 경우 비즈니스 파트너`
        ...
        {
          title: "5. 데이터 보존",
          content: `귀하의 개인정보는 계정이 활성화되어 있거나 서비스 제공에 필요한 기간 동안 보존됩니다. 가상 피팅을 위해 업로드된 이미지는 처리 후 1시간 이내에 자동 삭제됩니다. 언제든지 연락을 통해 데이터 삭제를 요청할 수 있습니다.`
        },
        {
